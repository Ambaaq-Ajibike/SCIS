...
public static class SeedData
{
    public static async Task SeedAsync(SCISDbContext context)
    {
        ...
        {
            new() { FirstName = "John", LastName = "Doe", PatientId = "PAT001", DateOfBirth = new DateTime(1985, 5, 15), Gender = "Male", PhoneNumber = "555-1001", Email = "john.doe@email.com", HospitalId = 1, BiometricConsent = true, BiometricConsentDate = DateTime.UtcNow.AddDays(-30) },
            new() { FirstName = "Jane", LastName = "Smith", PatientId = "PAT002", DateOfBirth = new DateTime(1990, 8, 22), Gender = "Female", PhoneNumber = "555-1002", Email = "jane.smith@email.com", HospitalId = 2, BiometricConsent = true, BiometricConsentDate = DateTime.UtcNow.AddDays(-15) },
            new() { FirstName = "Mike", LastName = "Johnson", PatientId = "PAT003", DateOfBirth = new DateTime(1978, 12, 3), Gender = "Male", PhoneNumber = "555-1003", Email = "mike.johnson@email.com", HospitalId = 3, BiometricConsent = true, BiometricConsentDate = DateTime.UtcNow.AddDays(-7) },
            new() { FirstName = "Sarah", LastName = "Williams", PatientId = "PAT004", DateOfBirth = new DateTime(1992, 3, 18), Gender = "Female", PhoneNumber = "555-1004", Email = "sarah.williams@email.com", HospitalId = 4, BiometricConsent = true, BiometricConsentDate = DateTime.UtcNow.AddDays(-20) },
            new() { FirstName = "David", LastName = "Brown", PatientId = "PAT005", DateOfBirth = new DateTime(1988, 7, 9), Gender = "Male", PhoneNumber = "555-1005", Email = "david.brown@email.com", HospitalId = 5, BiometricConsent = true, BiometricConsentDate = DateTime.UtcNow.AddDays(-10) }
        };
