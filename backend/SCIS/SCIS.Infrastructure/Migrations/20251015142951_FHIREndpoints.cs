...
{
    /// <inheritdoc />
    public partial class FHIREndpoints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DataRequestEndpoints",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    HospitalId = table.Column<Guid>(type: "uuid", nullable: false),
                    DataType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    DataTypeDisplayName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    IsEndpointValid = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    EndpointParameters = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    AllowedRoles = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataRequestEndpoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataRequestEndpoints_Hospitals_HospitalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataRequestEndpoints_HospitalId_DataType",
                table: "DataRequestEndpoints",
                columns: new[] { "HospitalId", "DataType" },
                unique: true);
        }
